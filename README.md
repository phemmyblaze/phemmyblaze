...
const phemmy = {
  ...
  funFact() {
    return "When I'm not coding, I'm lost in music or deep in meme archaeology 😎";
  },

  philosophy  : "If the UI isn't delightful, the job isn't done.",
};
```
...
> *"Great software is built by people who care — about the code, the user, and each other."*

Got a project idea? Want to collaborate? Or just want to talk React?

**DM me on** [![Twitter](https://img.shields.io/badge/@phemmyblaz-%231DA1F2.svg?style=flat-square&logo=Twitter&logoColor=white)](https://twitter.com/phemmyblaz) or connect on [![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/akinuliolaakinbobola/)
...
![Profile Views](https://komarev.com/ghpvc/?username=phemmyblaze&color=blueviolet&style=flat-square)
